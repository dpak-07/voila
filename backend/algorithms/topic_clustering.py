...
DOMAINS = [
    ...
    (2, "Billing, Invoices & Payment Inquiries", "billing, charge, invoice, payment", ["billing", "bill", "refund", "charge", "invoice", "payment", "card", "cost", "price", "overcharge", "wallet", "subscription", "pagamento", "fatura", "cobrança", "preco", "cartao", "promocao", "promoo", "fee", "charged", "double charged", "overcharged", "payment failed", "payment declined", "payment error"]),
    (3, "Account Access & Password Authentication", "login, password, auth, 2fa", ["login", "password", "sign", "account", "auth", "reset", "email", "code", "otp", "2fa", "lock", "verify", "senha", "conta", "acesso", "entrar", "forgot password", "reset password", "unable to login", "cannot login", "access denied", "account locked", "account blocked", "account suspended"]),
    ...
    (7, "Customer Service & Support Quality", "agent, support, representative, supervisor", ["agent", "representative", "helpdesk", "supervisor", "manager", "escalation", "customer service", "customer support", "customer care", "support agent", "call center", "contact support", "no response from support", "waiting for support", "support not responding", "complaint unresolved", "escalate complaint", "speak to manager"]),
    (8, "Transaction Issues & Transfers", "transaction, transfer, upi, wallet", ["transaction", "recharge", "upi", "wallet", "transfer", "reversal", "credited", "deducted", "transaction failed", "transaction pending", "transaction declined", "money transfer", "transfer failed", "upi failed", "recharge failed", "money not received", "money deducted"]),
]
