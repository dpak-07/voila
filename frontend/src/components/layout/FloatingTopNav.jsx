      ...
      <header className="fixed top-2.5 sm:top-3.5 left-1/2 -translate-x-1/2 z-40 w-[96%] max-w-[1560px] rounded-2xl bg-white/80 dark:bg-slate-950/75 backdrop-blur-2xl border border-slate-200/90 dark:border-white/10 px-3 sm:px-4 py-2 sm:py-2.5 flex items-center justify-between gap-3 shadow-xl dark:shadow-2xl transition-all duration-300">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3.5 min-w-0">
          <NavLink to="/" className="flex items-center gap-2.5 group shrink-0" title="Voilà Intelligence">
            <div className="w-8 h-8 rounded-xl bg-indigo-500/10 border border-indigo-500/20 p-1 flex items-center justify-center shadow-xs dark:shadow-[0_0_12px_rgba(99,102,241,0.2)] group-hover:scale-105 transition-all">
          ...
          <div className="relative shrink-0">
            <button
              ...
              className={`flex items-center gap-1.5 px-2.5 py-1 rounded-xl text-xs font-sans font-medium transition-colors border cursor-pointer ${
                hasActiveFilters
                  ? 'bg-indigo-50 dark:bg-indigo-600/30 text-indigo-700 dark:text-indigo-200 border-indigo-300 dark:border-indigo-500/40 shadow-xs dark:shadow-[0_0_12px_rgba(99,102,241,0.2)]'
                  ...
                  <div className="flex items-center justify-between pb-2 mb-3 border-b border-slate-100 dark:border-white/10">
                    <div>
                      ...
                      <span className="text-[10px] text-slate-500 dark:text-slate-400">
                        Filter telemetry across channels
                      </span>
                    </div>
                    <button
              ...
              >
                {isActive && (
                  <motion.div
                    ...
                    className="absolute inset-0 rounded-lg bg-white dark:bg-indigo-600/30 border border-slate-200/80 dark:border-indigo-500/40 shadow-xs dark:shadow-[0_0_15px_rgba(99,102,241,0.3)]"
        ...
        <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white font-medium transition-all text-xs cursor-pointer shadow-[0_0_16px_rgba(99,102,241,0.35)]"
          >
