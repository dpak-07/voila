        ...
        {!isLoading && !hasAnyData && (
          ...
          >
            <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-b from-white via-white/95 to-indigo-50/30 dark:from-slate-900 dark:via-slate-900/95 dark:to-indigo-950/20 border border-slate-200/90 dark:border-white/10 shadow-xl text-center space-y-4 relative overflow-hidden">
              ...
              <button
                onClick={() => navigate('/upload')}
                className="px-8 py-3 rounded-2xl bg-gradient-to-r from-indigo-600 via-indigo-500 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white text-sm font-bold shadow-lg shadow-indigo-500/30 transition-all inline-flex items-center gap-2.5 cursor-pointer"
              >
                <UploadCloud className="w-4 h-4" />
